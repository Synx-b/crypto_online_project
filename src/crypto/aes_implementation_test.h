/*
 * File: aes_implementation_test.h
 * Created: 20/01/2018 21:12
 * Finished:
 *
 * Description:
 *
...
#ifndef CRYPTO_ONLINE_PROJECT_AES_IMPLEMENTATION_TEST_H
#define CRYPTO_ONLINE_PROJECT_AES_IMPLEMENTATION_TEST_H
...
int test_aes_implementation(void) {
...
static void test_encrypt_ecb_verbose(void)
{
    ...
    for (i = 0; i < 4; ++i)
    {
        aes_ecb_encrypt(&aes, plain_text + (i * 16));
...
//  uint8_t buffer[64];
    ...
    aes_init_iv(&aes, key, iv);
    aes_cbc_decrypt_buffer(&aes, in, 64);
...
static void test_encrypt_cbc(void)
{
    ...
    aes_init_iv(&aes, key, iv);
    aes_cbc_encrypt_buffer(&aes, in, 64);
...
#endif //CRYPTO_ONLINE_PROJECT_AES_IMPLEMENTATION_TEST_H
