...
This directory contains all the code required for the authentication system in my project. It handles the login and register form.
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=1]{algorithm/questions_algorithm.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.4]{aes-keysch-128.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.4]{aes-keysch-192.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.4]{aes-keysch-256.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.4]{aes-decryption-overview.png}
\end{center}
...
Then in order to calculate $(B_4, B_5, B_6, B_7)$ we just use the input $(C_4, C_5, C_6, C_7)$. $B_i$ and $C_i$ are elements from $GF(2^8)$ and also the constants in our matrix are elements of $GF(2^8)$. It should also be said that additions in the vector-matrix multiplication are bitwise XOR's.

\subsubsection{Inverse ShiftRows Layer}

In order to reverse the Shift Rows Layer all we have to do is shift the elements in the state matrix the opposite direction. The first row is not affected as it is also not affected in the normal ShiftRows layer. With our state matrix $B = (B_0, B_1, B_2, B_3, ..., B_15)$:
...
\begin{tikzpicture}[scale=1]
	...
	\draw (0,3) rectangle node { $b_0$} +(1,1);
	\draw (0,2) rectangle node { $b_{13}$} +(1,1);
	\draw (0,1) rectangle node { $b_{10}$} +(1,1);
	\draw (0,0) rectangle node { $b_7$} +(1,1);
	\draw (1,3) rectangle node { $b_4$} +(1,1);
	\draw (1,2) rectangle node { $b_1$} +(1,1);
	\draw (1,1) rectangle node { $b_{14}$} +(1,1);
	\draw (1,0) rectangle node { $b_{11}$} +(1,1);
	\draw (2,3) rectangle node { $b_8$} +(1,1);
	\draw (2,2) rectangle node { $b_5$} +(1,1);
	\draw (2,1) rectangle node { $b_2$} +(1,1);
	\draw (2,0) rectangle node { $b_{15}$} +(1,1);
	\draw (3,3) rectangle node { $b_{12}$} +(1,1);
	\draw (3,2) rectangle node { $b_9$} +(1,1);
	\draw (3,1) rectangle node { $b_6$} +(1,1);
	\draw (3,0) rectangle node { $b_3$} +(1,1);
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.7]{aes-inv-sbox.jpeg}
\end{center}
...
\STATE{Psuedocode for the Question/Answer Algorithm}

\STATE{QuestionAnswer(string question\_id, string question\_answer)}
\STATE{begin}
\vspace{1em}
\STATE{$dbAPI \leftarrow DatabaseAPI(question\_id, question\_answer)$}
\vspace{1em}
\STATE{$dbAPI.StoreData()$}
\STATE{$dbAPI.GetCorrectAnswer()$}
\STATE{$answer\_result \leftarrow dbAPI.IsAnswerCorrect()$}
\vspace{1em}
\IF{$answer\_result$ is true}
    \STATE{Show User Answer Is Correct}
\ELSIF{$answer\_result$ is false}
    \STATE{Show User Answer is Incorrect}
\ELSE
    \STATE{Catch Any Errors}
\ENDIF
...
\begin{algorithm}[H]
\begin{algorithmic}
\STATE{Psuedocode for the AES Cipher}


\STATE{Cipher(byte input[4*Nb], byte output[4*Nb], word w[Nb*(Nr+1)])}
\STATE{begin}
...
\begin{algorithm}[H]
\begin{algorithmic}
\STATE{Psuedocode for the Inverse AES Cipher}

\STATE{InvCipher(byte input[4*Nb], byte output[4*Nb], word w[Nb*(Nr+1)])}
\STATE{begin}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.3]{dbschema/db_user.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.3]{dbschema/user_answered_questions.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.3]{dbschema/auth_info.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.3]{dbschema/auth_identity.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.3]{dbschema/auth_token.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.3]{dbschema/questions.png}
\end{center}
...
\begin{figure}[H]
\hspace{-2cm} 
\includegraphics[scale=0.2]{dbschema/schema.png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.4]{ux/left_header.png}
\end{center} 
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.4]{ux/right_header.png}
\end{center} 
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.4]{ux/left_header_user.png}
\end{center} 
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.4]{ux/left_header_admin.png}
\end{center} 
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.4]{ux/right_header_user.png}
\end{center} 
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.3]{ux/nav_grid_cb.png}
\end{center} 
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.25]{ux/nav_grid_sc.png}
\end{center} 
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.25]{ux/nav_grid_asc.png}
\end{center} 
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.25]{ux/nav_grid_protocols.png}
\end{center} 
\caption{Protocols}
\label{ux_protocol}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.3]{ux/login_form.png}
\end{center}
\hspace{-2cm} 
\caption{Login Form}
\label{ux_login_form}
...
\hspace{-2cm}
\begin{center}
\includegraphics[scale=0.4]{ux/register_form.png}
\end{center} 
